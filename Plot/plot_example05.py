...
#文件名
exp_idx = '01'
idxs_nn = ['09_01', '00_10', '09_20', '09_50']
...
for i in range(len(idxs_nn)):
    # 使用绝对路径
    file_path = f'./TikPINN_fullobs/output/non_smooth/result_{idxs_nn[i]}/result50000.txt'
    ...
    file_path = f'./Dolfin-adjoint/non_smooth/result_{idxs[i]}/result.txt'
