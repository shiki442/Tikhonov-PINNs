"""
Generate 2D data for Example 02.
...
import os
from problems.example02 import Example02Problem
from generate_data import generate_data_nd, save_data_pt


def main():
    # Create problem instance
    problem = Example02Problem()
    ...
    for noise_level in noise_levels:
        ...
        # Create filename: example02_data01.pt, example02_data10.pt, etc.
        noise_str = f"{int(noise_level * 100):02d}"
        file_name = f"example02_data{noise_str}.pt"
