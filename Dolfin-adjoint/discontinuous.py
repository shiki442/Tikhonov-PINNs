...
def Inverse_potential(noise_level, lamb):
    ...
    # plt.savefig(f"discontinuous/q_{noise_level}_{lamb}.png")
    # plt.show()
    # plt.close()
    ...
    # plt.savefig(f"discontinuous/u_{noise_level}_{lamb}.png")
    # plt.show()
    # plt.close()

    # out_q = XDMFFile(f"discontinuous/q_scipy_{noise_level}_{lamb}.xdmf")
    ...
    # out_u = XDMFFile(f"discontinuous/u_scipy_{noise_level}_{lamb}.xdmf")
